 ...
 *  by writing to VRAM
 * 
 * @param xi horizontal coordinate of "first" endpoint  
 * @param yi vertical coordinate of "first" endpoint
 * @param xf horizontal coordinate of "last" endpoint  
 * @param yf vertical coordinate of "last" endpoint * 
